data "aws_ami" "joindevops" {
    owners           = ["973714476881"] # this one i ll get in the ami details, this owner ll not change, take it.
...
#catalogue_sg_id, through data source., this data source , we are taking from ssm parameter, which, mainly 10-securitygorup folder, sends backend_alb_sg_id to SSM Parameter, and this backend_alb_sg_id comes from outputs of module [Module-terraform-aws-securitygroup]
